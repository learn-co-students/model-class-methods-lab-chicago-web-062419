class Boat < ActiveRecord::Base
  ...
  def self.without_a_captain
    ...
    #* self/boat class, Boat.without_a_captain would return all boats with a id of nil.
  end

  def self.sailboats
    includes(:classifications).where(classifications: { name: 'Sailboat' })
    #* include all boats where classification = 'Sailboat'
  end
  ...
  def self.longest
    ...
    #* Descending(highest to lowest) order of length:, only returning first
  end
end
